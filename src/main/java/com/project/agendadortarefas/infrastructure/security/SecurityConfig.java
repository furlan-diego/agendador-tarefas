...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, UserDetailsService userDetailsServiceImpl) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .anyRequest().authenticated() // Requer autenticação para todas as outras requisições/endpoints.
                )
